...
class LuarNegeriController extends Controller
{
    public function index()
    {
        ...
        return view('admin.tupoksi.kerjasama.luarnegeri', compact('luarnegeri'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return back()->with([
            'message' => 'Berhasil memasukkan perguruantinggi luarnegeri',
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with([
            'message' => 'Berhasil mengupdate perguruantinggi luarnegeri',
        ]);
    }
}
