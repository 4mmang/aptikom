...
class AkreditasiController extends Controller
{
    public function index()
    {
        ...
        return view('admin.tupoksi.perguruantinggi.akreditasi', compact('akreditasi'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return back()->with([
            'message' => 'Berhasil memasukkan perguruantinggi akreditasi',
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with([
            'message' => 'Berhasil mengupdate perguruantinggi akreditasi',
        ]);
    }
}
