...
class ManajemenController extends Controller
{
    public function index()
    {
        ...
        return view('admin.tupoksi.perguruantinggi.manajemen', compact('manajemen'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return back()->with([
            'message' => 'Berhasil memasukkan perguruantinggi manajemen',
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with([
            'message' => 'Berhasil mengupdate perguruantinggi manajemen',
        ]);
    }
}
