...
class PenulisanController extends Controller
{
    public function index()
    {
        ...
        return view('admin.tupoksi.sdm.penulisan', compact('penulisan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return back()->with([
            'message' => 'Berhasil memasukkan perguruantinggi penulisan',
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with([
            'message' => 'Berhasil mengupdate perguruantinggi penulisan',
        ]);
    }
}
