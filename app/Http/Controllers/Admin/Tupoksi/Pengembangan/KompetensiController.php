...
namespace App\Http\Controllers\Admin\Tupoksi\Pengembangan;
...
class KompetensiController extends Controller
{
    public function index()
    {
        ...
        return view('admin.tupoksi.sdm.kompetensi', compact('kompetensi'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return back()->with([
            'message' => 'Berhasil memasukkan perguruantinggi kompetensi',
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with([
            'message' => 'Berhasil mengupdate perguruantinggi kompetensi',
        ]);
    }
}
