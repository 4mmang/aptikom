...
class FungsionalController extends Controller
{
    public function index()
    {
        ...
        return view('admin.tupoksi.sdm.fungsional', compact('fungsional'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return back()->with([
            'message' => 'Berhasil memasukkan perguruantinggi fungsional',
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with([
            'message' => 'Berhasil mengupdate perguruantinggi fungsional',
        ]);
    }
}
