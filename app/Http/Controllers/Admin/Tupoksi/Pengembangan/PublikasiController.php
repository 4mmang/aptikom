...
class PublikasiController extends Controller
{
    public function index()
    {
        ...
        return view('admin.tupoksi.sdm.publikasi', compact('publikasi'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return back()->with([
            'message' => 'Berhasil memasukkan perguruantinggi publikasi',
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with([
            'message' => 'Berhasil mengupdate perguruantinggi publikasi',
        ]);
    }
}
