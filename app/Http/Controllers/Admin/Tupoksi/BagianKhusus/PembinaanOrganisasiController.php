...
class PembinaanOrganisasiController extends Controller
{
    public function index()
    {
        $pembinaanorganisasi = PembinaanOrganisasi::find(1);
        return view('admin.tupoksi.bagiankhusus.pembinaanorganisasi', compact('pembinaanorganisasi'));
    }
    ...
    public function store(Request $request)
    {
        ...
        PembinaanOrganisasi::create([
            'judul' => $request->judul,
            'isi' => $description,
        ]);

        return back()->with([
            'message' => 'Berhasil memasukkan pembinaan organisasi',
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $pembinaanorganisasi->update([
            'judul' => $request->judul,
            'isi' => $description,
        ]);

        return back()->with([
            'message' => 'Berhasil mengupdate pembinaan organisasi',
        ]);
    }
}
