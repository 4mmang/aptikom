...
class LegalitasController extends Controller
{
    public function index()
    {
        ...
        return view('admin.tupoksi.bagiankhusus.legalitas', compact('legalitas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return back()->with([
            'message' => 'Berhasil memasukkan legalitas dan advokasi',
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with([
            'message' => 'Berhasil mengupdate legalitas dan advokasi',
        ]);
    }
}
