...
class PenerbitanController extends Controller
{
    public function index()
    {
        ...
        return view('admin.tupoksi.otonom.penerbitan', compact('penerbitan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return back()->with([
            'message' => 'Berhasil memasukkan penerbitan penerbitan',
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with([
            'message' => 'Berhasil mengupdate penerbitan penerbitan',
        ]);
    }
}
