...
use DOMDocument;
class LspInformatikaController extends Controller
{
    public function index()
    {
        $lspinformatika = LspInformatika::find(1);
        return view('admin.tupoksi.otonom.lspinformatika', compact('lspinformatika'));
    }
    ...
    public function store(Request $request)
    {
        ...
        LspInformatika::create([
            'judul' => $request->judul,
            'isi' => $description,
        ]);

        return back()->with([
            'message' => 'Berhasil memasukkan lspinformatika lspinformatika',
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $lspinformatika->update([
            'judul' => $request->judul,
            'isi' => $description,
        ]);

        return back()->with([
            'message' => 'Berhasil mengupdate lspinformatika lspinformatika',
        ]);
    }
}
