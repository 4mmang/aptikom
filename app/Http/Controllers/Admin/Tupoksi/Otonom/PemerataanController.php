...
use DOMDocument;
class PemerataanController extends Controller
{
    public function index()
    {
        $pemerataan = Pemerataan::find(1);
        return view('admin.tupoksi.otonom.pemerataan', compact('pemerataan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return back()->with([
            'message' => 'Berhasil memasukkan pemerataan pemerataan',
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with([
            'message' => 'Berhasil mengupdate pemerataan pemerataan',
        ]);
    }
}
