...
class KesektariatanController extends Controller
{
    public function index()
    {
        $kesektariatan = Kesektariatan::find(1);
        return view('admin.tupoksi.kesektariatan.index', compact('kesektariatan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Kesektariatan::create([
            'judul' => $request->judul,
            'isi' => $description,
        ]);

        return back()->with([
            'message' => 'Berhasil memasukkan kesektariatan',
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $kesektariatan->update([
            'judul' => $request->judul,
            'isi' => $description,
        ]);

        return back()->with([
            'message' => 'Berhasil mengupdate kesektariatan',
        ]);
    }
}
