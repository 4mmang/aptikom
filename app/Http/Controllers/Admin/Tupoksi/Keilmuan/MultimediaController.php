...
class MultimediaController extends Controller
{
    public function index()
    {
        ...
        return view('admin.tupoksi.keilmuan.multimedia', compact('multimedia'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return back()->with([
            'message' => 'Berhasil memasukkan keilmuan multimedia',
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with([
            'message' => 'Berhasil mengupdate keilmuan multimedia',
        ]);
    }
}
