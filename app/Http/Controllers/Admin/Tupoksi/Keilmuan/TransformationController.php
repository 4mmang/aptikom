...
class TransformationController extends Controller
{
    public function index()
    {
        ...
        return view('admin.tupoksi.keilmuan.transformation', compact('transformation'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return back()->with([
            'message' => 'Berhasil memasukkan keilmuan transformation',
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with([
            'message' => 'Berhasil mengupdate keilmuan transformation',
        ]);
    }
}
