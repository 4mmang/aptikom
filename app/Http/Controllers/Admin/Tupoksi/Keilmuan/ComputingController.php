...
class ComputingController extends Controller
{
    public function index()
    {
        ...
        return view('admin.tupoksi.keilmuan.computing', compact('computing'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return back()->with([
            'message' => 'Berhasil memasukkan keilmuan computing',
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with([
            'message' => 'Berhasil mengupdate keilmuan computing',
        ]);
    }
}
