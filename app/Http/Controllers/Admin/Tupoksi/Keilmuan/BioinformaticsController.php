...
class BioinformaticsController extends Controller
{
    public function index()
    {
        $bioinformatics = Bioinformatics::find(1);
        return view('admin.tupoksi.keilmuan.bioinformatics', compact('bioinformatics'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Bioinformatics::create([
            'judul' => $request->judul,
            'isi' => $description,
        ]);

        return back()->with([
            'message' => 'Berhasil memasukkan keilmuan bioinformatics',
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with([
            'message' => 'Berhasil mengupdate keilmuan bioinformatics',
        ]);
    }
}
